...
This module is no longer compatible with Omeka S 3.x

- The module is now compatible with ARK URLs provided by the Quark module
- Show resource page blocks in item set metadata block

## [0.5.0] - 2026-03-16

- Add navigation link to go back on item set
...
[0.6.0]: https://github.com/biblibre/omeka-s-module-ItemSetCalendar/releases/tag/v0.6.0
[0.5.0]: https://github.com/biblibre/omeka-s-module-ItemSetCalendar/releases/tag/v0.5.0
